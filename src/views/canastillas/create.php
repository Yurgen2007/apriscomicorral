...
<head>
    ...
    <title>Crear Canastilla - <?php echo SITE_NAME; ?></title>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="form-container">
                <form method="POST" action="<?php echo BASE_URL; ?>/canastillas/create" class="cabra-form">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="descripcion" id="descripcion" rows="3"
                                      placeholder="Descripción adicional de la canastilla..."><?php echo isset($_SESSION['form_data']['descripcion']) ? e($_SESSION['form_data']['descripcion']) : ''; ?></textarea>
                        </div>
