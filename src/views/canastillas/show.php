...
<head>
    ...
    <title><?php echo e($canastilla['nombre'] ?? 'Canastilla'); ?> - Canastilla - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="container">
        <header class="dashboard-header">
            <h1>📦 <?php echo e($canastilla['nombre'] ?? 'Canastilla'); ?></h1>
                ...
                <div class="cabra-detail-card">
                    ...
                    <div class="cabra-info-section">
                        <div class="info-header">
                            <h2><?php echo e($canastilla['nombre'] ?? 'Canastilla'); ?></h2>
                        </div>
                            ...
                            <div class="info-group">
                                ...
                                <div class="info-items">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span><?php echo !empty($canastilla['fecha_registro']) ? date('d/m/Y H:i:s', strtotime($canastilla['fecha_registro'])) : '-'; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="detail-actions">
                            <a href="<?php echo BASE_URL; ?>/canastillas/<?php echo $canastilla['id_canastilla'] ?? 0; ?>/edit" class="btn btn-warning">✏️ Editar</a>
                            <form method="POST" action="<?php echo BASE_URL; ?>/canastillas/<?php echo $canastilla['id_canastilla'] ?? 0; ?>/delete" style="display:inline-block;" onsubmit="return confirm('¿Estás seguro de eliminar esta canastilla?')">
                        ...
                        <table class="cabras-table">
                            ...
                            <tbody>
                                <?php foreach ($pajillas as $pajilla): ?>
                                    <?php $isAgotada = ($pajilla['dosis_disponibles'] ?? 0) <= 0; ?>
                                    <tr <?php echo $isAgotada ? 'style="opacity: 0.6;"' : ''; ?>>
                                        <td><strong><?php echo e($pajilla['nombre_ejemplar'] ?? 'Sin nombre'); ?></strong><?php echo $isAgotada ? ' <span class="text-muted">(Agotada)</span>' : ''; ?></td>
                                        <td><?php echo e($pajilla['registro_ejemplar'] ?? '-'); ?></td>
                                        <td><?php echo e($pajilla['tamano'] ?? '-'); ?></td>
                                        <td><?php echo e($pajilla['cantidad'] ?? 0); ?></td>
                                        <td><?php echo e($pajilla['dosis_disponibles'] ?? 0); ?></td>
                                        <td>
                                            <a href="<?php echo BASE_URL; ?>/pajillas/<?php echo $pajilla['id_pajilla'] ?? 0; ?>" class="btn btn-sm btn-info">Ver</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
