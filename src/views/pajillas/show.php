...
<head>
    ...
    <title><?php echo e($pajilla['nombre_ejemplar']); ?> - Pajilla - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="container">
        <header class="dashboard-header">
            <h1>🧪 <?php echo e($pajilla['nombre_ejemplar']); ?></h1>
            <div style="display: flex; gap: 10px;">
                <a href="<?php echo BASE_URL; ?>/pajillas/<?php echo $pajilla['id_pajilla']; ?>/edit" class="btn btn-warning">
                    <i class="fas fa-edit"></i> Editar
                </a>
                <?php if ($pajilla['dosis_disponibles'] > 0): ?>
                    <a href="<?php echo BASE_URL; ?>/pajillas/<?php echo $pajilla['id_pajilla']; ?>/venta" class="btn btn-success">
                ...
                <div class="cabra-detail-card">
                    ...
                    <div class="cabra-info-section">
                        <div class="info-header">
                            <h2><?php echo e($pajilla['nombre_ejemplar']); ?></h2>
                            <?php if ($pajilla['dosis_disponibles'] > 0): ?>
                            ...
                            <div class="info-group">
                                ...
                                <div class="info-items">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span><?php echo e($pajilla['nombre_ejemplar']); ?></span>
                                    </div>
                                    <div class="info-item">
                            ...
                            <div class="info-group">
                                ...
                                <div class="info-items">
                                    <div class="info-item">
                                        ...
                                        <span class="sex-badge-large <?php echo $pajilla['cantidad'] > 0 ? 'macho' : 'hembra'; ?>">
                                            <?php echo e($pajilla['cantidad']); ?> paja(s)
                                        </span>
                                    </div>
                                    <div class="info-item">
                                        <strong>Dosis Disponibles:</strong>
                                        <span class="sex-badge-large <?php echo $pajilla['dosis_disponibles'] > 0 ? 'hembra' : 'macho'; ?>">
                                            <?php echo e($pajilla['dosis_disponibles']); ?> dosis
                                        </span>
                                    </div>
                                    <div class="info-item">
                                        <strong>Fecha de Registro:</strong>
                                        <span><?php echo date('d/m/Y H:i:s', strtotime($pajilla['fecha_registro'])); ?></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="detail-actions">
                            <form method="POST" action="<?php echo BASE_URL; ?>/pajillas/<?php echo $pajilla['id_pajilla']; ?>/delete" style="display:inline-block;" onsubmit="return confirm('¿Estás seguro de eliminar esta pajilla? Esta acción no se puede deshacer.')">
    ...
    .cabra-photo-section { background: #f8f9fa; display: flex; align-items: center; justify-content: center; min-height: 300px; }
    .cabra-detail-image { width: 100%; height: 400px; object-fit: contain; border-radius: 20px; }
    .no-photo-large { font-size: 100px; color: #ddd; }
    ...
    .status-badge-large { padding: 8px 16px; border-radius: 25px; font-weight: bold; font-size: 0.9em; }
    .status-badge-large.activa { background: #d4edda; color: #155724; }
    .status-badge-large.inactiva { background: #f8d7da; color: #721c24; }
    .sex-badge-large { padding: 6px 12px; border-radius: 20px; font-weight: bold; font-size: 0.9em; }
    .sex-badge-large.macho { background: #fff8f8; color: #d32f2f; }
    .sex-badge-large.hembra { background: #e8f5e9; color: #2e7d32; }
